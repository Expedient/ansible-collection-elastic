    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <b>Default:</b><br/><div style="color: blue">"Ansible created rule"</div>
                </td>
                <td>
                        <div>Description of the ruleset</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Dictionary of ignored associations</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>List of rules in ruleset</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>The desired state for the traffic ruleset</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        ...
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">cluster is up to date</div>
                </td>
            </tr>
    </table>
    <br/><br/>
