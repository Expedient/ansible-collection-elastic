...
.. _expedient.elastic.ece_snapshot_repo_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Access key for the S3 bucket</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>S3 bucket to use for snapshot data</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <b>Default:</b><br/><div style="color: blue">"s3.amazonaws.com"</div>
                </td>
                <td>
                        <div>S3 endpoint to connect to</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>name of the snapshot repo</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>secret key for the S3 bucket</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
